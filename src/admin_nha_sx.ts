import { TNha_SX, urlserver } from './common.js';
export const form_them_nha_sx = () => {
    return `
    <form class='col-9 m-auto border-primary p-2'>
        <div class='mb-3'>
...
export const them_nha_sx = async () => {
    ...
    let opt={method:'post', body:JSON.stringify(data), header:{'Content-type':'application/json'}}
