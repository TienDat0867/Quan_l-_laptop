const urlserver = 'http://localhost:3000'; // Địa chỉ server
const tygia = 25000; // Tỷ giá quy đổi VNĐ sang USD
...
// Định nghĩa interface cho thuộc tính
...
class CSan_Pham implements ISan_Pham {
    ...
    giausd() {
        return (this.gia / tygia).toFixed(0) + " USD";
    }
}

// Lớp laptop kế thừa từ lớp sản phẩm
